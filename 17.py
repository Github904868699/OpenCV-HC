...
class MainWindow(QtWidgets.QWidget):
    ...
    def __init__(self, colors: List[ColorCfg]):
        ...
        self.setStyleSheet(
            """
            QGroupBox { font-weight: bold; border: 1px solid #777; margin-top: 8px; border-radius: 4px; }
            ...
            QPushButton:hover {
                background-color: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #f8f8f8, stop:1 #bbb);
            }
            QPushButton:pressed {
                background-color: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #ddd, stop:1 #aaa);
            }
            """
        )
    ...
    def append_log(self, msg: str):
        """Display a line of text in the log box."""
